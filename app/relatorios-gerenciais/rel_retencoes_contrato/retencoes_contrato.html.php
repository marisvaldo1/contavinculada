<?php $template = new \templates\TemplateBootstrap4pikeAdmin(['retencoes_contrato.css'], ['retencoes_contrato.js']); ?>
<?php $template->inicioConteudo() ?>

<?php
if (!verificaAcesso('retencoes_contrato'))
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="card mb-3">
            <div class="card-header">
                <h3><i class="fa fa-2x fa-address-card"></i> Retenções por Contrato</h3>
            </div>
...
<form id="formRetencoesContrato" style="display: none">
