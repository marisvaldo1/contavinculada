...
$(document).ready(function () {
    ...
    $('#sidebar-menu ul .liberacoes-contrato').addClass('active');
...
/*
 * Imprimir Liberações por contrato.
 */
$(document).on('click', '#botao-imprimir', function () {
    ...
    var parametros = {
        ...
        tipo_relatorio: 'Libera&ccedil;&otilde;es por Contrato',
    ...
    document.getElementById("formLiberacoesContrato").action = "liberacoes_contrato_html.php";
    document.getElementById("formLiberacoesContrato").method = "POST";
    document.getElementById("formLiberacoesContrato").target = "_blank";
    document.getElementById("parametros").value = JSON.stringify(parametros);
    document.getElementById("formLiberacoesContrato").submit();
    return;
});
