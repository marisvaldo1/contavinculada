...
class TemplateBootstrapLogin4pikeAdmin {
    ...
    function __construct($css = [], $js = []) {
        ...
        define('TEMPLATE_HTTP', SITE . 'core/templates/bootstrapLogin4pikeAdmin/');
        $this->arquivo = RAIZ . 'core/templates/bootstrapLogin4pikeAdmin/padrao.php';
        //dd(SITE . 'static/img/');
    ...
    public static function paginaExcecao($ex) {
        ...
        include RAIZ . 'core/templates/bootstrapLogin4pikeAdmin/html/excecao.html.php';
    }
